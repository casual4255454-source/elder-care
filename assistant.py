"""
Elder Care Voice Assistant v2.0 — Smart Healthcare Companion
=============================================================
A smart, conversational voice assistant for elder care using:
  - Ollama (Llama 3 8B) for intent analysis & conversation
  - SpeechRecognition for voice input
  - pyttsx3 for text-to-speech output
  - Conversation memory for context-aware responses
  - Dynamic medicine management (add/delete/list via voice)
  - Health symptom detection & home remedy advice
  - Weather, news, and joke features
  - Local JSON logging for daily routines
